...
sep = nrow(projectivity_participant) / 2
...
top_words_select <- top_words[c("Word", "valence_bin", "arousal_bin", "residuals_abs")]
kable(top_words_select)
```
